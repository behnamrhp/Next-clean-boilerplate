...
Example: [user i repository](https://github.com/behnamrhp/Next-clean-boilerplate/blob/develop/src/feature/core/user/domain/i-repo/user.repository.interface.ts)
...
Example: [User module](https://github.com/behnamrhp/Next-clean-boilerplate/blob/develop/src/feature/core/user/data/module/user-module.ts)
...
2. **Dependency Injection Setup**:
    ...
    We implemented a child DI container that registers each repository implementation using its corresponding interface key (defined in our domain contracts).
...
Example: [Feature di](https://github.com/behnamrhp/Next-clean-boilerplate/blob/develop/src/feature/common/server.di.ts)
...
For reference, see the user domain implementation in the [user-module-key](https://github.com/behnamrhp/Next-clean-boilerplate/blob/develop/src/feature/core/user/data/user-module-key.ts) file.

Also in feature di file by adding new module for new domains we can add new domain module to the lis of `getDi` modules.

### Usage 
At the end how we can get the repository in usecase layer like this:

Example: [Create user usecase](https://github.com/behnamrhp/Next-clean-boilerplate/blob/develop/src/feature/core/user/domain/usecase/create-user.usecase.ts)
...
Example: [Dashboard app module](https://github.com/behnamrhp/Next-clean-boilerplate/blob/develop/src/app/%5Blang%5D/dashboard/module/dashboard.app-module.ts)
...
Example: [Dashboard layout](https://github.com/behnamrhp/Next-clean-boilerplate/blob/develop/src/app/%5Blang%5D/dashboard/layout.tsx)
...
Example: [Latest Invoice](https://github.com/behnamrhp/Next-clean-boilerplate/blob/develop/src/app/%5Blang%5D/dashboard/components/server/latest-invoices.tsx)
